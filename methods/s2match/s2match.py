...
def main(arguments):
    ...
    f1 = open(args.f[1], 'r')
    while True:
        cur_amr1 = get_amr_line(f0)
        cur_amr2 = get_amr_line(f1)
        ...
        (best_mapping, best_match_num_soft, best_iteration, log10_search_space, runtime) = get_best_match(instance1, attributes1, relation1,
